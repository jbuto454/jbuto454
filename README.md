...
Data engineer with 5+ years of product management experience, now building the systems I used to spec. Currently finishing my Master's in Computer and Information Technology at UPenn.
...
- Performance optimization via HashMap lookups and memoization
- **Stack:** Java, REST APIs

## Tech Stack

```
Languages:      Python | SQL | Java
Data:           dbt | Snowflake | Databricks | Iceberg
...
I spent 5 years as a PM shipping mobile security products at F-Secure and Lookout (contributed to a $223M acquisition). Now I'm on the other side—building data infrastructure instead of writing tickets for it.

## Let's Connect

📍 Knoxville, TN  
📫 [buto@seas.upenn.com](mailto:buto@seas.upenn.com)  
💼 [LinkedIn](https://www.linkedin.com/in/jake-buto/)

*Currently looking for data engineering and backend roles.*
